...
public partial class PostEffectsBase : MonoBehaviour
{
    ...
    public virtual void OnRenderImage2(RenderTexture source, RenderTexture destination)
    {
    }

    public virtual void OnRenderImage3(RenderTexture sourceAndDestination, RenderTexture temp)
    {
    }

    public virtual bool PreferRenderImage3()
    {
        return false;
    }
