...
public partial class MouseOrbit : MonoBehaviour
{
    ...
    public virtual void Start()
    {
        ...
        this.auxX = this.x = angles.y;
        this.auxY = this.y = angles.x;
    ...
    public virtual void LateUpdate()
    {
        if (this.target)
        {
            ...
            this.auxX = Mathf.Lerp(this.auxX, this.x, Time.deltaTime * this.dampSpeed);
            this.auxY = Mathf.Lerp(this.auxY, this.y, Time.deltaTime * this.dampSpeed);
            Quaternion rotation = Quaternion.Euler(this.auxY, this.auxX, 0);
